...
export default function Footer() {
    ...
    const aStyle = 'hover:text-[#32D164] cursor-pointer'

  return (
    <footer className='flex justify-center w-screen h-full bg-[rgb(45,49,77)]'>
        <div className='w-full max-w-5xl flex flex-row justify-between py-8'>
            ...
            <div className='flex flex-col ml-[-150px] gap-2 text-white'>
            ...
            <div className='flex flex-col gap-6'>
                <button className='font-semibold text-white px-2 py-2 rounded-3xl bg-gradient-to-r from-[#32D164] to-[#22D3EB] hover:opacity-60'>
                    Request invite
                </button>
